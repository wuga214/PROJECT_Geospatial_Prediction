...
public class BowyerWatson {
	...
	public BowyerWatson(double sx, double sy,double w,double h, ArrayList<DPoint> p){
	...
	public void initial(double sx,double sy, double w,double h){
		initpoints=new ArrayList<DPoint>();
		DPoint a=new DPoint(sx,sy);
		DPoint b=new DPoint(sx,sy+h);
		DPoint c=new DPoint(sx+w,sy+h);
		DPoint d=new DPoint(sx+w,sy);
